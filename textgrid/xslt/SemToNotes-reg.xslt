...
<xsl:stylesheet xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template match="tei:pb">
        <xsl:if test="(./preceding::tei:lb[@type!='empty'])[last()]/@type = 'reg'">
    ...
    <xsl:template match="tei:lb">
        <xsl:if test="./@type != 'empty' and (./preceding::tei:lb[@type!='empty'])[last()]/@type = 'reg'">
...
<!--    <xsl:if test="(./preceding::tei:lb[@type!='empty'])[last()]/@type = '{ $type }'"> -->
  ...
  <!--  ################################
    ...
    <xsl:template match="tei:note[@n]">
        ...
        <xsl:if test="./parent::tei:div[@type = 'reg']">
